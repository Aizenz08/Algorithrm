 ...
 * @author DMX TAN AN
 */
enum SORTTYPE{Ascending_Order, Decreasing_Order};
public class FrameSecond extends JFrame{
	...
	pnNothBorder.setLayout(new BoxLayout(pnNothBorder, BoxLayout.Y_AXIS));
        ...
        combo2.add(con);
        combo2.setSize(1920,1080);
        combo2.setTitle("Random Numbers");
        combo2.setVisible(true);
        combo2.setLocationRelativeTo(null);
        combo2.setDefaultCloseOperation(EXIT_ON_CLOSE);
        ...
        startButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch(n){
                    case 0:
                        SortType = SORTTYPE.Ascending_Order;
                        break;
                    case 1:
                        SortType = SORTTYPE.Decreasing_Order;
                        break;
                }
                panelRunble run = new panelRunble(pnCenter);
        ...
        txtNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt){
                    ...
                    if(n > 15){
                            JOptionPane.showMessageDialog(rootPane, "Xin lỗi, dữ liệu vượt quá giới hạn. Max array(15)");
                            txtNumber.setText("");
                    }
